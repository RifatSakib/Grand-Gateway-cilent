  ...
  return (
    ...
    <footer className="footer sm:footer-horizontal bg-base-200 text-base-content mt-4 md:mt-8 p-10">
      <aside>
        ...
        <p>
          <span className='text-orange-400 text-xl font-bold'> <span className='text-red-600'>Grand</span>-Gateway</span>
          <br />
        ...
        <fieldset className="form-control w-80" >
          <label className="label flex-col justify-start items-start p-0 m-0 gap-2">
            ...
            <div className='w-full pr-4'>
              ...
              <a href="mailto:sakibrifat353@gmail.com" className="btn bg-gradient-to-b from-[#7f8b73] via-[#95a387] to-[#b9cba7] bg-opacity-20 backdrop-blur-lg shadow-lg  w-full text-black"> <BiLogoGmail /> sakibrifat353@gmail.com</a>
            </div>

            <div className='w-full pr-4'>


              <a href="https://wa.me/8801791634313" className="btn bg-gradient-to-b from-[#7f8b73] via-[#95a387] to-[#b9cba7] bg-opacity-20 backdrop-blur-lg shadow-lg  w-full text-black"> <FaSquareWhatsapp />
              +8801791634313</a>
            </div>
    ...
    <footer className="bg-base-300 text-base-content p-6 w-full flex justify-center items-center">
      <p className="text-lg font-medium text-center text-[#7F8B73]">
