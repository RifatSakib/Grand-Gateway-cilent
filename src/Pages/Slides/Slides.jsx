                        ...
                        <div className=' m-10 md:flex gap-4'>
                            ...
                            <div className='w-full space-y-5 my-auto  '>
                                <div className='w-[80%] mx-auto space-y-5'>
                                    ...
                                    <h1 className='text-[#AAB99A] text-4xl font-bold'>Fast & Secure Parcel Delivery!</h1>
                        ...
                        <div className='m-10 md:flex gap-4 p-4'>
                            ...
                            <div className='w-full space-y-5 my-auto  '>
                                <div className='w-[80%] mx-auto space-y-5'>
                                    ...
                                    <h1 className='text-[#AAB99A] text-4xl font-bold'>Hassle-Free Parcel Booking at Your Fingertips!</h1>
                        ...
                        <div className=' m-10 md:flex gap-4 p-4'>
                            ...
                            <div className='w-full space-y-5 my-auto  '>
                                <div className='w-[80%] mx-auto space-y-5'>
                                    ...
                                    <h1 className='text-[#AAB99A] text-4xl font-bold'>Your Trusted Parcel Delivery Partner!</h1>
