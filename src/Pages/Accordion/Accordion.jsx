    ...
    return (
        ...
        className='py-10 flex flex-col gap-2'>
            ...
            <div className="collapse bg-[#99a78a]">
                ...
                <div className="collapse-title text-xl font-medium text-black" >Why Choose Our Advanced User Dashboard?</div>
                <div className="collapse-content">
            ...
            <div className="collapse bg-[#7f8b73]">
                <input type="radio" name="my-accordion-1" />
                <div className="collapse-title text-xl font-medium text-black">Why Grand-Gateway is Perfect for Admins?</div>
                <div className="collapse-content">
